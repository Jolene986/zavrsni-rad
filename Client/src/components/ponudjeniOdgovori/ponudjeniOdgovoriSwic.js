...
const ponudjeniOdgovoriSwic = props => {
  ...
  switch (props.tip) {
    case "success":
      ponudjenOdg = (
        <PonudjeniOdgCheckbox
          odg={props.ponudjeniOdg}
          provera={props.provera}
        />
      );
      break;
    case "danger":
      ponudjenOdg = <PonudjeniOdgInput provera={props.provera} />;
      break;
    case "warning":
      ponudjenOdg = (
        <PonudjeniOdgSlike odg={props.ponudjeniOdg} provera={props.provera} />
      );
      break;
    case "info":
      ponudjenOdg = (
        <PonudjenOdgDnD odg={props.ponudjeniOdg} provera={props.provera} />
      );
      break;
    default:
      ponudjenOdg = null;
  }
  return <Pomocna>{ponudjenOdg}</Pomocna>;
};
